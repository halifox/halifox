...
| [NatCheck](https://github.com/halifox/NatCheck) | 一款基于 Flutter 和 RFC 5780 构建的 NAT 类型检测工具，支持 iOS、Android、Windows、macOS、Linux 平台。|
...
| [MaccyForWindows](https://github.com/halifox/MaccyForWindows) | 一款基于 Flutter 开发的跨平台剪贴板管理工具，参考 macOS 端 Maccy 的交互设计，提供轻量化的剪贴板历史记录管理与快速检索功能。 |
